...
namespace Entidades
{
    public class DirectorTecnico :Persona
    {
        ...
        public string MostrarDatos()
        {
            ...
            datos.AppendLine($" Fecha de Nacimiento del Director: {this.fechaNacimiento.ToString("yyyyy/MM/dd")}");
        ...
        //por que en las sobrecargas no puedo acceder como base?
        //como es static no puedo usar el base porque es del objeto. 
        public static bool operator !=(DirectorTecnico dt1, DirectorTecnico dt2)
        {
            return !(dt1 == dt2);
        }
